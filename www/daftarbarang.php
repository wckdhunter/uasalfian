...
$resultbrg = mysqli_query($mysqli, "SELECT * FROM barang ORDER BY id DESC"); // using mysqli_query instead
?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Daftar Barang</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                             ...
                                             <?php
                                              while($resbrg = mysqli_fetch_array($resultbrg)) {       
                                                    echo "<tr>";
                                                    echo "<td>".$resbrg['nama_barang']."</td>";
                                                    echo "<td>Rp ".$resbrg['harga']."</td>";
                                                    echo "<td>".$resbrg['ram']."</td>";
                                                    echo "<td>".$resbrg['warna']."</td>";       
                                                    echo "<td> <a href=\"editbarang.php?id=$resbrg[id]\">Edit</a> <a href=\"deletebrg.php?id=$resbrg[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><button >Hapus</button></a></td>";    
                                                    echo "</tr>";   
                                                }
                                                ?>
                                        </tbody>
